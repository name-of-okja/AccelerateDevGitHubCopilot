...
using Library.Infrastructure.Data; // 추가
...
public class ConsoleApp
{
    ...
    static string ReadBookTitle()
    {
        ...
        while (String.IsNullOrWhiteSpace(searchInput))
        {
            Console.Write("Enter a string to search for book by name: ");
